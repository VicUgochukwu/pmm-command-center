...
**`counter-narratives`** — Tracks what they say about you (true or not), how to counter it, and what legitimate concerns you can raise about them. Includes ethical boundaries. *(10-15 min read, update ongoing)*
...
| "They said you're not secure" | counter-narratives → counter-strategies |
...
Copy `{{competitor-1}}/`, rename it to the competitor's name, and populate. The fastest path is using the **Context Builder** agent (if you've set up `06-agents/`) or AI-assisted prompts — see the [Setup Guide](../../SETUP-GUIDE.md) for the exact approach.
