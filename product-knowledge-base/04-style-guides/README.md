...
During onboarding, the **Context Builder** agent populates this file from your brand voice notes, positioning docs, and messaging context. If you don't have explicit brand guidelines, the agent infers voice and tone from whatever you share — every brand has a voice even if it's not documented.
...
- **Asset Builder** — References writing principles for every piece of content it creates
- **Alignment Auditor** — Scores content against the Style & Voice dimension (0-15 points) using this file
- **Context Builder** — Populates this file during onboarding and updates it when new brand context is shared
