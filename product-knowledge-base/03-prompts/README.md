...
You don't need to use these directly — the **Asset Builder** agent reads them automatically when you ask for content. But you can also use them as standalone prompts in any AI tool.
