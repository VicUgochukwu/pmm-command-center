...
What gets templatized is not the transcript — it's the **extraction schema**. The Context Builder reads whatever you provide, fills out the debrief template, and surfaces recommended updates to your knowledge base. Nothing updates automatically — you review and approve first.
...
For each transcript, the Context Builder fills out `_debrief-template.md` and surfaces:
