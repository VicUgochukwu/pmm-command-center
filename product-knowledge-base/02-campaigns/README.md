...
The **Asset Builder** agent can draft both briefs from your segment context and campaign goals. The **Pipeline Runner** uses briefs as input for full content pipelines — it will create the campaign folder, populate briefs, generate assets, and run quality review.
