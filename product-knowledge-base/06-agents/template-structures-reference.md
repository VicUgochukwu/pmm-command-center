...
Compact reference for all PMM Command Center template structures. **Agents: read this file instead of reading individual template files.** Only open individual files when writing populated versions.
